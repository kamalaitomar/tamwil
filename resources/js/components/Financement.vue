    ...
    <div class="m-3">
        <div class="row col-12">
            ...
            <div class="col-10 row justify-content-center  text-center">
                    ...
                    <div class="col-2 d-flex " @click.prevent="cyclesStep()" style="cursor: pointer">
                    ...
                    <div class="col-2 d-flex " @click.prevent="besoinsStep()" style="cursor: pointer">
                    ...
                    <div class="col-2 d-flex " @click.prevent="fasciculesStep()" style="cursor: pointer">
                    ...
                    <div class="col-2 d-flex " @click.prevent="offresStep()" style="cursor: pointer">
        ...
        <div class="row col-12">
            <!-- back button  -->
            <div class="col-1">
                <button v-if="curentStep > 1 && curentStep < 4 &&  loading == false" @click.prevent="pretStep" class="btn btn-primary m-2" :title="__('tamwil.back')">
