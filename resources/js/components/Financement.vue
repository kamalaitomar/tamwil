        ...
        <div class="justify-content-center col-10">
            ...
            <div class="col-12 row justify-content-center text-center">
                <div class="col-2 d-flex " >
                    <div class="col-12 d-flex align-items-center justify-content-center" @click.prevent="profilsStep()" style="cursor: pointer" :class="{'text-primary': curentStep === 1}">
                ...
                <div class="col-2 d-flex">
                    <div class=" col-12 d-flex align-items-center justify-content-center" @click.prevent="cyclesStep()" style="cursor: pointer" :class="{'text-primary': curentStep === 2}">
                ...
                <div class="col-2 d-flex ">
                    <div class=" col-12 d-flex align-items-center justify-content-center" @click.prevent="besoinsStep()" style="cursor: pointer" :class="{'text-primary': curentStep === 3}">
                        <div class="m-1 p-2 col-12">
                            <div class="col-12">
