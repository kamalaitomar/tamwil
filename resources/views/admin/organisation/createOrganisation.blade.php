    ...
    <div class="p-5" >
        ...
        <div class="tab-content m-3" id="myTabContent">
            <div class="tab-pane fade show active" id="fr" role="tabpanel" aria-labelledby="home-tab">
                <form class="user" action=" {{ route('organisation.store') }} " method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group d-flex justify-content-center">
                        <div class="col-6  mb-3 mb-sm-0">
                            ...
                            <textarea type="text" class="form-control " id="presentation" name="presentation" rows="10" >{{old('presentation')}}</textarea>
                            @error('presentation')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
            ...
            <div class="tab-pane fade text-right" id="ar" role="tabpanel" aria-labelledby="nav-profile-tab" dir="rtl"> 
                    ...
                    <div class="form-group d-flex justify-content-center">
                        <div class="col-6  mb-3 mb-sm-0">
                            ...
                            <textarea type="text" class="form-control " id="presentation_ar" name="presentation_ar" rows="10" >{{old('presentation_ar',)}}</textarea>
